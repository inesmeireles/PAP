...
// Cria uma serial nas portas 2 (RX) e 3 (TX)SoftwareSerial minhaSerial(2 , 3); 
// Define que o modulo ira utilizar a serial minhaSerialESP8266 wifi(minhaSerial);
...
void loop(void){    
  ...
  Serial.println(wifi.getVersion().c_str());    // Define modo de operacao como STA (station)    
